        ...
        <div className="contact__group">
          <div className="contact__options">
            <article className="contact__option">
              ...
              <h3>Email</h3>
              <h5>ashishrajpoot004@gmail.com</h5>
              <a href="mailto:ashishrajpoot004@gmail.com" target='_blank' rel="noopener noreferrer" className='btn'>Send a message</a>
            </article>
            ...
            <article className="contact__option">
              ...
              <h3>WhatsApp</h3>
              <h5>+91 6387182087</h5>
              <a href="https://wa.me/9517424951" target='_blank' className='btn'>Send a message</a>
            </article>
          </div>
